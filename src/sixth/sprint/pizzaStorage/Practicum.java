...
public class Practicum {
        ...
        while (!"exit".equals(action)) {
            if ("show".equals(action)) {
                ...
                try {
                    ...
                    throw new NotEnoughPizzaException("Недостаточное количество пиццы не складе");
                }
            }
    ...
    public static void add(final PizzaStorage storage) throws TooMuchPizzaException {
        ...
        } catch (TooMuchPizzaException exp) {
            throw new TooMuchPizzaException("Произошла ошибка: " + exp.getMessage());
        }
    }
    ...
    public static void take(final PizzaStorage storage) throws NotEnoughPizzaException {
        try {
            ...
            System.out.println("Произошла ошибка: " + exception.getMessage());
        } catch (NotEnoughPizzaException exception) {
            throw new NotEnoughPizzaException("Произошла ошибка: " + exception.getMessage());
        }
    }
